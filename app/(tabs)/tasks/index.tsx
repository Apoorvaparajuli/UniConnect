...
const challenges = [
  {
    ...
    description: "Build a model bridge and test its strength.",
    due: "Due 20 May 2024",
    priority: "High",
    color: "#FF4D4F",
    icon: "bridge",
  },
  {
    ...
    description: "Observe and record plant growth over time.",
    due: "Due 22 May 2024",
    priority: "Medium",
    color: "#FF9F1C",
    icon: "leaf",
  },
  {
    ...
    description: "Test the pH and quality of local water sources.",
    due: "Due 25 May 2024",
    priority: "Low",
    color: "#25B46B",
    icon: "water",
  },
  {
    ...
    description: "Measure the efficiency of solar panels.",
    due: "Due 28 May 2024",
    priority: "Low",
    color: "#3B82F6",
